    ...
    <PageLayout title="Celebrating 15 years of phpMyFAQ">
      <div className="row">
        <div className="col-xs-12">
          <p>
            <strong>February 2016. The internet.</strong>
            <br />
            The development of phpMyFAQ started back in february 2001 then Thorsten Rinne and Bastian Pöttner wrote the
            first lines of PHP 3 code for a nonofficial FAQ for the German hosting company Strato. First they tried to
            ...
            open source the code under the terms of the Mozilla Public License Version 1.1 (MPL), since phpMyFAQ 2.8 the
            code is licensed under the terms of the Mozilla Public License Version 2.0. Nowadays phpMyFAQ supports PHP
            5.5+ and PHP 7 and even HHVM.
          </p>
          ...
          <ul>
            ...
            <li>We used several version control systems: 7,5 years CVS, 1 year SVN and 6,5 years now with Git</li>
            <li>We released 166 different versions from 0.6 back in February 2001 to 2.8.26 in February 2016</li>
            <li>phpMyFAQ 1.0 was a 100KB package, phpMyFAQ 2.9 is a 6MB package</li>
            <li>phpmyfaq.de generates between 30 and 40 GB traffic per month, most of it for downloads</li>
            <li>demo.phpmyfaq.de serves phpMyFAQ running on PHP 5.4, 5.5, 5.6, 7.0 and HHVM.</li>
            <li>
              phpMyFAQ uses several open source quality assurance tools:{' '}
              <a rel="nofollow" target="_blank" href="https://travis-ci.org/thorsten/phpMyFAQ">
                Travis CI
              </a>
              ,{' '}
              <a rel="nofollow" target="_blank" href="https://scrutinizer-ci.com/g/thorsten/phpMyFAQ/">
                Scrutinizer
              </a>
              ,{' '}
              <a rel="nofollow" target="_blank" href="https://phpunit.de/">
                PHPUnit
              </a>
            </li>
          </ul>
