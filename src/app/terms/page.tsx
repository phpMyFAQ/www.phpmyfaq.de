      ...
      <div className="row">
        <div className="col-xs-12">
          ...
          <p>
            ...
            legally binding terms and conditions for your use of the Site at phpmyfaq.de.
          </p>
          <p>
          ...
          <p>
            Our Site may contain links to third-party sites that are not owned or controlled by Thorsten Rinne.
            <br />
            Thorsten Rinne has no control over, and assumes no responsibility for, the content, privacy policies, or
            practices of any third party sites or services. We strongly advise you to read the terms and conditions and
            privacy policy of any third-party site that you visit.
          </p>

          <h2>GOVERNING LAW</h2>
          <p>
            This Agreement (and any further rules, polices, or guidelines incorporated by reference) shall be governed
            and construed in accordance with the laws of Germany, without giving effect to any principles of conflicts
            of law.
          </p>

          <h2>CHANGES TO THIS AGREEMENT</h2>
          <p>
            We reserve the right, at our sole discretion, to modify or replace these Terms and Conditions by posting the
            updated terms on the Site. Your continued use of the Site after any such changes constitutes your acceptance
            of the new Terms and Conditions.
            <br />
            Please review this Agreement periodically for changes. If you do not agree to any of this Agreement or any
            changes to this Agreement, do not use, access or continue to access the Site or discontinue any use of the
            Site immediately.
          </p>

          <h2>CONTACT US</h2>
          <p>
            If you have any questions about this Agreement, please <a href="mailto:thorsten@phpmyfaq.de">contact us</a>.
          </p>
        </div>
      </div>
    </PageLayout>
