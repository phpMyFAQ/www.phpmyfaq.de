    ...
    <PageLayout title="Privacy Notice">
      <div className="row">
        <div className="col-xs-12">
          ...
          <p><span className="tsmcontroller">Thorsten Rinne<br/>
        Hermann-Hesse-Straße 16<br/>
        86830 Schwabmünchen<br/>
        Deutschland / Germany<br/>
        <br/>
        E-Mail: <a rel="nofollow"
                   href="&#109;&#97;ilto&#58;thor%73%74&#37;6&#53;n&#64;p&#104;p&#109;y%66&#97;q&#46;&#100;e">thorsten@phpmyfaq.de</a></span>
          </p>
          ...
          <p>Wir treffen nach Maßgabe des Art. 32 DSGVO unter Berücksichtigung des Stands der Technik, der
            ...
            der
            Daten gewährleisen. Ferner berücksichtigen wir den Schutz personenbezogener Daten bereits bei der
            Entwicklung,
            bzw. Auswahl von Hardware, Software sowie Verfahren, entsprechend dem Prinzip des Datenschutzes durch
            Technikgestaltung und durch datenschutzfreundliche Voreinstellungen berücksichtigt (Art. 25 DSGVO).<br/>
          </p>
          ...
          <p>Als „Cookies“ werden kleine Dateien bezeichnet, die auf Rechnern der Nutzer gespeichert werden. Innerhalb
            ...
            Login-Staus gespeichert werden. Als „permanent“ oder „persistent“ werden Cookies bezeichnet, die auch nach
            dem
            ...
            „Third-Party-Cookie“
            werden Cookies bezeichnet, die von anderen Anbietern als dem Verantwortlichen, der das Onlineangebot
            betreibt,
          ...
          <p>Die von uns verarbeiteten Daten werden nach Maßgabe der Art. 17 und 18 DSGVO gelöscht oder in ihrer
            ...
            werden
            die bei uns gespeicherten Daten gelöscht, sobald sie für ihre Zweckbestimmung nicht mehr erforderlich sind
            und
            der Löschung keine gesetzlichen Aufbewahrungspflichten entgegenstehen. Sofern die Daten nicht gelöscht
            werden,
          ...
          Speicherplatz und Datenbankdienste, Sicherheitsleistungen sowie technische Wartungsleistungen, die wir zum
...
Hierbei verarbeiten wir, bzw. unser Hostinganbieter Bestandsdaten, Kontaktdaten, Inhaltsdaten, Vertragsdaten,
          ...
          Browsertyp nebst Version, das Betriebssystem des Nutzers, Referrer URL (die zuvor besuchte Seite), IP-Adresse
          ...
          und die Datenverarbeitungsrichtlinien deren jeweiligen Betreiber. <br/>
        <br/>
          ...
          <p></p>
          <p><span className="ts-muster-content">Wir binden die Schriftarten ("Google Fonts") des Anbieters Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA, ein. Datenschutzerklärung: <a
          ...
          </p><a href="https://datenschutz-generator.de" className="dsg1-5" rel="nofollow" target="_blank">Erstellt mit
