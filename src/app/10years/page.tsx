    ...
    <PageLayout title="Celebrating 10 years of phpMyFAQ">
      <div className="row">
        <div className="col-xs-12">
          <p>
            <strong>February 2011. The internet.</strong><br />
            The development of phpMyFAQ started back in february 2001 then Thorsten Rinne and Bastian
            Pöttner wrote the first lines of PHP 3 code for a inofficial FAQ for the German webhosting
            ...
            terms of the Mozilla Public License Version 1.1 (MPL). Since then the user and code base grows
            and grows ... :-)
          </p>
          ...
          <ul>
            ...
            <li>
              We used several version control systems: 7,5 years CVS, 1 year SVN and 1,5 years now with Git
            </li>
            <li>
              We released 124 different versions from 0.6 back in february 2001 to 2.6.14 in january 2011
            </li>
            <li>
              phpMyFAQ 1.0 was a 100KB package, phpMyFAQ 2.7 is a 3.5MB package
            </li>
            <li>
              phpmyfaq.de generates between 20 and 30 GB traffic per month, most of it for downloads
            </li>
            <li>
              Language distribution: 30% English, 21% German, 14% Simplified Chinese, 11% Japanese, 5%
              French, 3% Spanish, all others are under 2%
            </li>
            <li>
              Currently 70% of our users are running on PHP 5.2, 30% are already using PHP 5.3
            </li>
            <li>
              47% of the phpMyFAQ installations are running on the Windows platform as intranet
              installations, 47% of the installations are running on Linux, mainly not as intranet
              installations
            </li>
            <li>
              53% of the installations are running on shared webhosting servers
            </li>
            <li>
              33% of our installation base are companies
            </li>
          </ul>
