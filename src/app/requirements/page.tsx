    ...
    <PageLayout title="System Requirements">
      <div className="row">
        <div className="col-12">
          <p className="lead">
            phpMyFAQ requires the following system components for proper operation.
          </p>
            ...
            <div className="col-md-6">
              <div className="card mb-4">
                <div className="card-body">
                  ...
                  <ul>
                    <li><strong>PHP 8.2+</strong> (8.3+ recommended)</li>
            ...
            <div className="col-md-6">
              <div className="card mb-4">
                <div className="card-body">
                  ...
                  <ul>
                    <li><strong>Apache 2.4+</strong> with mod_rewrite</li>
                    <li><strong>Nginx 1.18+</strong> with proper configuration</li>
                    <li><strong>IIS 10+</strong> with URL Rewrite Module</li>
            ...
            <div className="col-md-6">
              <div className="card mb-4">
                <div className="card-body">
                  ...
                  <ul>
                    <li><strong>MySQL 8.0+</strong> or <strong>MariaDB 10.6+</strong></li>
