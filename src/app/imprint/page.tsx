...
export const metadata: Metadata = generatePageMetadata('Imprint', 'Imprint for phpmyfaq.de');
    ...
    <PageLayout title="Imprint">
      <div className="row">
        <div className="col-xs-12">
          ...
          <p>
            <small>
              * Das ist meine Telefonnummer. Es ist wirklich meine Telefonnummer. Sie ist für Freunde und Bekannte. Sie
              ist nicht für Kontaktaufnahme wegen Fragen zu phpMyFAQ oder für "mal eben eine Frage zu PHP". Dafür gibt
              es E-Mail.
            </small>
          </p>
        </div>
