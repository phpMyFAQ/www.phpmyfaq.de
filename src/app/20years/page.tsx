    ...
    <PageLayout title="Celebrating 20 years of phpMyFAQ">
      <div className="row">
        <div className="col-xs-12">
          <p>
            <strong>February 2021. The internet.</strong>
            <br />
          ...
          <ul>
            ...
            <li>We used several version control systems: 7,5 years CVS, 1 year SVN and 11,5 years now with Git</li>
            <li>We released almost 200 different versions from 0.6 back in February 2001 to 3.0.7 in December 2020</li>
            <li>phpMyFAQ 1.0 was a 100KB package, phpMyFAQ 3.0 is a 7MB package</li>
            <li>phpmyfaq.de generates between 30 and 40 GB traffic per month, most of it for downloads</li>
            <li>demo.phpmyfaq.de serves phpMyFAQ running on PHP 7 and PHP 8.</li>
          </ul>
